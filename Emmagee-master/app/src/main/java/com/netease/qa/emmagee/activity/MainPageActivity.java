...
import com.netease.qa.emmagee.service.TestService;
...
public class MainPageActivity extends Activity {
	...
	private Button btnTest, startService;
	private int pid, uid;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		startService.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				startService(new Intent().setClass(getApplicationContext(), TestService.class));
			}
		});
		initTitleLayout();
